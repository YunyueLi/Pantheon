...
export const CRICKET_PLAYERS: Player[] = [
  ...
  mk({ id: "kapil-dev", name: "Kapil Dev", nation: "India", league: "IND", active: false, debut: 1978, wl: [1983], wc: [{ year: 1983, event: "ODI World Cup 1983" }], coy: [1983], blurb: "The captain who lifted India's first World Cup in 1983 and its Wisden Leading Cricketer that year; the country's greatest fast-bowling all-rounder." }),
  mk({ id: "ms-dhoni", name: "MS Dhoni", nation: "India", league: "IND", active: false, debut: 2004, wc: [{ year: 2007, event: "T20 World Cup 2007" }, { year: 2011, event: "ODI World Cup 2011" }], blurb: "The only captain to win both white-ball World Cups — the 2007 World T20 and the 2011 World Cup at home — and the coolest finisher of his age." }),
  mk({ id: "dennis-lillee", name: "Dennis Lillee", nation: "Australia", league: "AUS", active: false, debut: 1971, wl: [1972, 1977], coy: [1973], blurb: "Twice Wisden Leading Cricketer in the World and the archetypal fast bowler of the 1970s; a snarling spearhead with 355 Test wickets." }),
  mk({ id: "curtly-ambrose", name: "Curtly Ambrose", nation: "West Indies", league: "WIN", active: false, debut: 1988, wl: [1991], coy: [1992], blurb: "Wisden Leading Cricketer in the World for 1991 and the towering menace of West Indies' late pace dynasty; 405 Test wickets at 20.99." }),
  mk({ id: "allan-border", name: "Allan Border", nation: "Australia", league: "AUS", active: false, debut: 1978, wl: [1989], wc: [{ year: 1987, event: "ODI World Cup 1987" }], coy: [1982], blurb: "The captain who rebuilt Australian cricket and won the 1987 World Cup; Wisden Leading Cricketer for 1989 and a byword for obdurate batting." }),
  mk({ id: "steve-waugh", name: "Steve Waugh", nation: "Australia", league: "AUS", active: false, debut: 1985, wl: [1999], wc: [{ year: 1987, event: "ODI World Cup 1987" }, { year: 1999, event: "ODI World Cup 1999" }], coy: [1989], blurb: "A two-time World Cup winner and Wisden Leading Cricketer for 1999; the hard-nosed captain of Australia's golden dynasty." }),
  mk({ id: "anil-kumble", name: "Anil Kumble", nation: "India", league: "IND", active: false, debut: 1990, coy: [1996], blurb: "India's leading Test wicket-taker with 619, one of only two men to take all ten in a Test innings, and a 1996 Wisden Cricketer of the Year." }),
  mk({ id: "james-anderson", name: "James Anderson", nation: "England", league: "ENG", active: false, debut: 2002, wc: [{ year: 2010, event: "T20 World Cup 2010", part: 0.5 }], coy: [2009], blurb: "England's all-time leading Test wicket-taker with over 700, a 2009 Wisden Cricketer of the Year and swing bowling's great artist." }),
  mk({ id: "wally-hammond", name: "Wally Hammond", nation: "England", league: "ENG", active: false, debut: 1927, wl: [1929], coy: [1928], blurb: "Wisden Leading Cricketer in the World for 1929 and the dominant English batsman between the wars; 7,249 Test runs of imperious style." }),
  mk({ id: "len-hutton", name: "Len Hutton", nation: "England", league: "ENG", active: false, debut: 1937, wl: [1949, 1952], coy: [1938], blurb: "Twice Wisden Leading Cricketer in the World and scorer of a then-record 364; the first professional to captain England in the modern era." }),
  mk({ id: "clive-lloyd", name: "Clive Lloyd", nation: "West Indies", league: "WIN", active: false, debut: 1966, wl: [1975], wc: [{ year: 1975, event: "ODI World Cup 1975" }, { year: 1979, event: "ODI World Cup 1979" }], coy: [1971], blurb: "The captain who won the first two World Cups and built West Indies' invincible era; Wisden Leading Cricketer for 1975 after a final century." }),
  mk({ id: "sydney-barnes", name: "Sydney Barnes", nation: "England", league: "ENG", active: false, debut: 1901, wl: [1912], coy: [1910], blurb: "Wisden Leading Cricketer in the World for 1912 and, by reputation, the deadliest bowler in history — 189 Test wickets at 16.43." }),
  mk({ id: "dale-steyn", name: "Dale Steyn", nation: "South Africa", league: "RSA", active: false, debut: 2004, wl: [2013], coy: [2013], blurb: "Wisden Leading Cricketer in the World for 2013 and the finest fast bowler of his generation; 439 Test wickets of ferocious pace and swing." }),
  mk({ id: "ben-stokes", name: "Ben Stokes", nation: "England", league: "ENG", active: true, debut: 2011, wl: [2019, 2020, 2022], icc: [2019], wc: [{ year: 2019, event: "ODI World Cup 2019" }, { year: 2022, event: "T20 World Cup 2022" }], coy: [2016], blurb: "A three-time Wisden Leading Cricketer, the 2019 ICC Cricketer of the Year and the match-winning talisman of England's 2019 and 2022 World Cup triumphs." }),
];
