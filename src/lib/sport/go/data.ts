...
export const GO_PLAYERS: Player[] = [
  ...
  mk({ id: "park-junghwan", name: "Park Jung-hwan", nation: "South Korea", league: "KOR", active: true, debut: 2006, world: [["fujitsu", 2011], ["lg", 2015], ["mlily", 2018], ["chunlan", 2019], ["samsung", 2021]], dom: { 2007: 1, 2009: 2, 2010: 1, 2011: 2, 2012: 2, 2013: 2, 2014: 2, 2016: 1, 2017: 1, 2018: 2, 2019: 2 },
    blurb: "Long-time Korean No. 1 and five-time world champion, Shin Jin-seo's chief domestic rival." }),
  mk({ id: "shin-jinseo", name: "Shin Jin-seo", nation: "South Korea", league: "KOR", active: true, debut: 2012, world: [["lg", 2020], ["chunlan", 2021], ["lg", 2022], ["samsung", 2022], ["ing", 2023], ["lg", 2024], ["quzhou_lanke", 2024], ["nanyang", 2025]], dom: {},
    blurb: "The 'Shin God,' a generationally dominant world No. 1 with eight world titles by June 2025." }),
  mk({ id: "shin-minjun", name: "Shin Min-jun", nation: "South Korea", league: "KOR", active: true, debut: 2012, world: [["lg", 2021]], dom: {},
    blurb: "Solid Korean top-tenner who beat Ke Jie to win the 2021 LG Cup, his maiden world title." }),
  mk({ id: "byun-sang-il", name: "Byun Sang-il", nation: "South Korea", league: "KOR", active: true, debut: 2013, world: [["chunlan", 2023], ["lg", 2025]], dom: {},
  ...
  mk({ id: "ding-hao", name: "Ding Hao", nation: "China", league: "CHN", active: true, debut: 2015, world: [["lg", 2023], ["samsung", 2023], ["samsung", 2024]], dom: { 2019: 1, 2021: 3, 2022: 2, 2023: 1, 2025: 1 },
    blurb: "China's new No. 1, who won the 2023 LG Cup and back-to-back Samsung Cups in 2023–24." }),
  mk({ id: "wang-xinghao", name: "Wang Xinghao", nation: "China", league: "CHN", active: true, debut: 2016, world: [["other", 2025]], dom: {},
