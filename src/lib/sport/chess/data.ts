...
export const CHESS_PLAYERS: Player[] = [
  mk({ id: "garry-kasparov", name: "Garry Kasparov", nation: "Russia", league: "RUS", active: false, debut: 1980, wc: [1985, 1986, 1987, 1990, 1993, 1995], no1: [1984, 1985, 1986, 1987, 1988, 1989, 1990, 1991, 1992, 1993, 1995, 1997, 1998, 1999, 2000, 2001, 2002, 2003, 2004, 2005, 2006], cand: [1984], blurb: "Six world-title matches won and a record 21 years as the world's No. 1; the most dominant force the board has known." }),
  mk({ id: "magnus-carlsen", name: "Magnus Carlsen", nation: "Norway", league: "NOR", active: true, debut: 2001, wc: [2013, 2014, 2016, 2018, 2021], no1: [2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025], cand: [2013], blurb: "Five title matches won and an unbroken reign atop the rating list since 2011; the highest-rated player in history." }),
  ...
  mk({ id: "vladimir-kramnik", name: "Vladimir Kramnik", nation: "Russia", league: "RUS", active: false, debut: 1992, wc: [2000, 2004, 2006], no1: [1996, 2008], blurb: "Dethroned Kasparov in 2000 and reunified the crown in 2006; a deep strategist who never lost a title match on the board." }),
  mk({ id: "viswanathan-anand", name: "Viswanathan Anand", nation: "India", league: "IND", active: false, debut: 1987, wc: [2007, 2008, 2010, 2012], cand: [2014], blurb: "Undisputed champion 2007–2013 with three defenses; India's first grandmaster and the fastest calculator of his era." }),
  ...
  mk({ id: "veselin-topalov", name: "Veselin Topalov", nation: "Bulgaria", league: "BUL", active: false, debut: 1992, no1: [2007, 2009], cand: [2009], blurb: "Twice the year-end world No. 1 and a two-time world-title challenger; a fearless attacker who topped the rating list in 2007 and 2009." }),
