 ...
 * finishes and Major MVPs verified against HLTV and Liquipedia; frozen at end 2025.
...
export const CSGO_PLAYERS: Player[] = [
  ...
  mk({ id: "zywoo", name: "ZywOo", nation: "France", league: "FRA", active: true, debut: 2018, maj: [2023, 2025, 2025], no1: [2019, 2020, 2023, 2025], mvp: [2023, 2025, 2025], lan: [2024, 2025, 2025, 2025], blurb: "Mathieu Herbaut: record four-time HLTV No. 1 and three-time Major MVP; Vitality's untouchable AWP prodigy." }),
  ...
  mk({ id: "niko", name: "NiKo", nation: "Bosnia and Herzegovina", league: "BIH", active: true, debut: 2013, no1: [], mvp: [], lan: [2017, 2017, 2023, 2024, 2024], blurb: "Nikola Kovač: widely called the finest pure rifler ever, and the great nearly-man who reached 2026 without a Major." }),
  ...
  mk({ id: "ropz", name: "ropz", nation: "Estonia", league: "EST", active: true, debut: 2016, maj: [2022, 2025, 2025], lan: [2022, 2025, 2025], blurb: "Robin Kool: three Majors — one with FaZe, two with Vitality — and one of the most consistent riflers alive." }),
  ...
  mk({ id: "m0nesy", name: "m0NESY", nation: "Russia", league: "RUS", active: true, debut: 2021, no1: [], lan: [2023, 2024, 2024], blurb: "Ilya Osipov: the prodigy AWPer and 2024 HLTV runner-up who dominated for years before his first Major in 2026." }),
