...
export const TABLE_TENNIS_PLAYERS: Player[] = [
  ...
  mk({ id: "wang-chuqin", name: "Wang Chuqin", nation: "China", league: "CHN", gender: "M", active: true, debut: 2015, ws: [2025], ot: [2024], wt: [2018, 2022, 2024], db: [2019, 2021, 2023, 2023, 2024, 2025], tf: [2022, 2023, 2024], blurb: "2025 world champion and Olympic mixed/team gold medallist; the first left-handed Chinese world champ." }),
  mk({ id: "liang-jingkun", name: "Liang Jingkun", nation: "China", league: "CHN", gender: "M", active: true, debut: 2016, wt: [2022], blurb: "Hard-hitting four-time Worlds singles bronze medallist and 2022 world team gold winner for China." }),
  ...
  mk({ id: "tomokazu-harimoto", name: "Tomokazu Harimoto", nation: "Japan", league: "JPN", gender: "M", active: true, debut: 2016, tf: [2018], blurb: "Youngest-ever World Tour Grand Finals winner (2018) and Japan's spearhead against Chinese dominance." }),
  ...
  mk({ id: "sun-yingsha", name: "Sun Yingsha", nation: "China", league: "CHN", gender: "W", active: true, debut: 2017, ws: [2023, 2025], wcs: [2024, 2025], ot: [2020, 2024], wt: [2022, 2024], db: [2019, 2021, 2021, 2023, 2024, 2025], tf: [2021, 2022, 2023], blurb: "World No. 1 with two world and two World Cup singles titles, still chasing elusive Olympic singles gold." }),
  ...
  mk({ id: "wang-manyu", name: "Wang Manyu", nation: "China", league: "CHN", gender: "W", active: true, debut: 2015, ws: [2021], ot: [2020, 2024], wt: [2018, 2022, 2024], db: [2019, 2021, 2025], tf: [2024], blurb: "2021 world singles champion and two-time Olympic team gold medallist for China." }),
  mk({ id: "chen-xingtong", name: "Chen Xingtong", nation: "China", league: "CHN", gender: "W", active: true, debut: 2016, wt: [2022, 2024], blurb: "Top-three world-ranked attacker and two-time world team gold medallist, chasing her first major singles title." }),
