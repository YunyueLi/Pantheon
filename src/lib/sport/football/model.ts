...
const ACHIEVEMENTS: Record<string, AchievementMeta> = {
  ...
  copa_libertadores: { label: "Copa Libertadores", short: "Libertadores", bucket: "team", tier: "A", base: 230 },
  ...
  copa_sudamericana: { label: "Copa Sudamericana", short: "Sudamericana", bucket: "team", tier: "B", base: 75 },
  ...
  golden_shoe: { label: "European Golden Shoe", short: "Golden Shoe", bucket: "individual", tier: "A", base: 120 },
  wc_golden_boot: { label: "World Cup Golden Boot", short: "Golden Boot", bucket: "individual", tier: "A", base: 130 },
